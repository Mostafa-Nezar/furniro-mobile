      ...
      <View style={tw`flex-1 justify-end`}>
        <View style={[tw`rounded-t-3xl p-6`, { backgroundColor: theme.white, maxHeight: '80%' }]}>
          <View style={tw`flex-row justify-between items-center mb-6`}>
            ...
            <TouchableOpacity onPress={() => setShowFilters(false)}><Icon name="close" size={24} color={theme.black} /></TouchableOpacity>
          </View>
    ...
    <View style={[tw`flex-1`, { backgroundColor: theme.white }]}>
      ...
      <View style={tw`px-4 py-3`}>
        <View style={[tw`flex-row items-center border rounded-lg px-4 py-3`, { borderColor: theme.lightGray, backgroundColor: theme.semiWhite }]}> 
          ...
          <TouchableOpacity onPress={() => setShowFilters(true)}><Icon name="tune" size={20} color={theme.primary} /></TouchableOpacity>
        </View>
      </View>
