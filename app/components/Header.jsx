      ...
      <View
        ...
        <View style={tw`flex-row items-center flex-1`}>
          ...
          <View style={tw`flex-row items-center`}>
            <Image source={require("../../assets/images/Meubel House_Logos-05.png")} style={tw`w-8 h-8 mr-2`} resizeMode="contain"/>
            <Text style={[ tw`text-xl font-bold`, { color: theme.black, fontFamily: "Poppins-Bold" } ]}>
              {"Furniro"}
            </Text>
          </View>
        </View>
